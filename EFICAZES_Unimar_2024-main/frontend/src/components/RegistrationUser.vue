...
<template>
    ...
    <div class="registro grid md:grid-cols-5 md:gap-4 ml-5 mr-5">
      ...
      <form class="col-span-4 grid md:grid-cols-2 gap-4">
        ...
        <div class="text-right col-span-2">
          ...
          <button type="submit" id="btnNext" class="button" @click="formAddress"><b>Próximo Passo</b></button>
        </div>
      </form>
    </div>
  </main>
  <main class="cadastroEndereco" v-if="isVisible">
    ...
    <div class="text-right mt-14">
      ...
      <router-link to="/"><button id="btnSalvar" class="button" @click="createUser"><b>Salvar</b></button></router-link>
    </div>
  </main>
</template>

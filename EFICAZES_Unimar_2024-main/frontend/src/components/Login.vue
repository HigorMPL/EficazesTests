      ...
      <form @submit.prevent="login">
        <div class="flex flex-col items-start w-[410px] mt-8">
          ...
          <div class="relative w-full">
            <div class="flex">
              <input v-model="user.email" type="email" id="userEmail" class="w-full h-[50px] rounded-lg bg-[#F1F3F6] p-2 pr-10 border"
        ...
        <div class="flex flex-col items-start w-[410px] mt-8">
          ...
          <div class="flex relative w-full">
            <input v-model="user.senha" type="password" id="userSenha" class="w-full h-[50px] rounded-lg bg-[#F1F3F6] p-2 pr-10 border"
        ...
        <div>
          <button type="submit"
            id="btnLogin" class="flex w-[410px] h-[50px] mb-[41px] bg-black text-white font-semibold items-center justify-center mt-[33px] rounded-lg shadow-custom-blue">
